...
- 6 detailed use cases spanning different industries:
  ...
  3. **Retail** - Legacy POS to Cloud with Real-Time Analytics
  4. **Healthcare** - Medical Records to Predictive Health Analytics
  5. **Enterprise Strategy** - "We Want AI But Don't Know Where to Start"
  6. **Productization** - Internal Tool to Revenue Stream
...
- Success factors and qualification questions

**Use when**:
- Tailoring pitch to specific industry
- Showing similar use case to prospect
- Discussing timelines and investment levels
- Qualifying opportunity fit
- Building ROI business case
...
- Audience-specific messaging:
  - C-Suite / Executive
  - VP of Operations / Line of Business
  - CTO / Technical Teams
  - Sales / Business Development
  - Academic / Educational
- Social media content hooks and pillars
- Geographic/market-specific positioning
- Demo/POC narrative structure
- Common objections and responses
- Competitive positioning matrix

**Use when**:
- Sales calls with specific persona
- Pitching to different departments
...
1. Start with [TALKING_POINTS.md](TALKING_POINTS.md) — use the persona-specific pitches
2. Reference [USE_CASES.md](USE_CASES.md) — find similar industry/situation
3. Dive into [SKILL.md](SKILL.md) — understand full service portfolio for deeper questions

### If you're a **Solution Architect / Delivery Lead**
1. Start with [USE_CASES.md](USE_CASES.md) — understand delivery methodology and phasing
2. Reference [SKILL.md](SKILL.md) — core services and how they connect
3. Use [TALKING_POINTS.md](TALKING_POINTS.md) — technical differentiators and objection handling

### If you're a **Business Development / Account Executive**
1. Start with [SKILL.md](SKILL.md) — overall positioning and services
2. Reference [USE_CASES.md](USE_CASES.md) — ROI stories and business impact
3. Use [TALKING_POINTS.md](TALKING_POINTS.md) — sales qualification questions and competitive positioning

### If you're **Marketing / Content Creation**
1. Reference [SKILL.md](SKILL.md) — service descriptions and value props
2. Reference [USE_CASES.md](USE_CASES.md) — case study narratives
...
This skill is designed to be used within your Copilot chat sessions:

1. **Reference specific sections** in proposals and emails
2. **Cite use cases** when responding to RFPs
3. **Use talking points** as a basis for email templates and presentations
4. **Extract ROI numbers** for business cases and pitch decks
5. **Reference qualification questions** during sales discovery calls
...
|------|---------|----------|--------|
| SKILL.md | Core service portfolio, positioning | Everyone | ~8 pages |
| USE_CASES.md | Implementation stories, ROI details | Sales, Solutions, Executives | ~15 pages |
| TALKING_POINTS.md | Tactical messaging, objection handling | Sales, Marketing, Leadership | ~12 pages |
...
- Detailed service pricing guides
- Industry-specific market research
- Certification and credential details
- Team bios and expertise areas
- Partner integrations and technology stack details
...
If you encounter gaps or areas needing clarification, this skill can be updated with additional:
- Use cases from new industries
- Expanded talking points for specific personas
